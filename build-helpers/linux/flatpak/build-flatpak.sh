...
DESKTOP_SOURCE="${ROOT_DIR}/build-helpers/linux/flatpak/com.firebadnofire.rtspviewer.desktop"
METAINFO_SOURCE="${ROOT_DIR}/build-helpers/linux/flatpak/com.firebadnofire.rtspviewer.metainfo.xml"
...
APP_ID="com.firebadnofire.rtspviewer"
...
resized_icon="${workspace}/com.firebadnofire.rtspviewer-512.png"
